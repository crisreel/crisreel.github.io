...
EOF;
        ...
        // Captura el texto adicional de la URL
        $texto_adicional = isset($_GET['texto_adicional']) ? $_GET['texto_adicional'] : '';
        ...
        $bloque5 = <<<EOF
            ...
            <table style="font-size:10px; padding:5px 10px;">
                ...
                <tr>
                    <td colspan="3" style="color:#333; background-color:white; width:540px; text-align:center">
                        Observación: $texto_adicional
                    </td>
                </tr>
